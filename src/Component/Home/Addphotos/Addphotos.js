...
const Addphotos = ({ addedPhoto, onChange }) => {
          ...
          addedPhoto.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-black py-3 px-2 bg-opacity-50 rounded-2xl"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-black py-3 px-2 bg-opacity-50 rounded-2xl"
              >
                {link === addedPhoto[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
